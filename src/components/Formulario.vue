<template>
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 text-white bg-secondary" :style="'background-color:'+this.form.cor+'!important'">
                ...
                <hr>
                <div class="mb-3 row">
                    <spam>Nome: {{this.form.nome}}</spam>
                </div>
                <div class="mb-3 row">
                    <spam>E-mail: {{this.form.email}}</spam>
                </div>
                <div class="mb-3 row">
                    <spam>Senha:{{this.form.senha}}</spam>
                </div>
                <div class="mb-3 row">
